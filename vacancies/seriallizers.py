...
# метод в сериализаторе на проверку валидности is_valid

class VacancyCreateSerializer(serializers.ModelSerializer):
    id = serializers.IntegerField(required=False)
    # вывести поле в связанной модели. нужно использовать SlugRelatedField и в slug_field пишем поле которое нужно вывести
    skills = serializers.SlugRelatedField(
        required=False,
        many=True,
